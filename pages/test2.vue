...
<template>
    <div >
     ...
     <!-- レスポンシブにFlexboxとCSS Gridを使い分ける -->
      <div class="flex justify-center px-2">   
            <!-- デフォルトでCSS Grid、md以上はFlexbox -->   
            <div class="grid gap-4 grid-cols-1 sm:grid-cols-1 md:flex md:gap-4  midFoto">
                    <div class="sm: flex justify-center flex-none md:basis-1/5">
                          <div>
                              <div class="my-2">
                    ...
                    <div class="flex-none md:basis-2/5">
                          <div >
